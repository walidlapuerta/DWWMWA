...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <li class="nav-item dropdown">
            ...
            <!-- <li class="nav-item">
            <a class="nav-link" href="Facile.php">Facile</a>
            </li>           
            <li class="nav-item">
            <a class="nav-link" href="Moyen.php">Moyen</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="Difficile.php">Difficile</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="Armes.php">Armes</a>
            </li> -->
        </ul>
        </div>
    </div>
